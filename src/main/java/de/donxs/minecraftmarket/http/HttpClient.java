package de.donxs.minecraftmarket.http;
...
public class HttpClient {
    ...
    private static final EventLoopGroup eventLoop = new NioEventLoopGroup(2, new ThreadFactoryBuilder().setNameFormat("TwitchBot-Thread-#").build());
